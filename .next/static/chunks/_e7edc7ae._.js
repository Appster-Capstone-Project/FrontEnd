...
const DishCard = ({ dish })=>{
    ...
    const portionsText = dish.portionsAvailable !== undefined ? dish.portionsAvailable > 0 ? `${dish.portionsAvailable} portion${dish.portionsAvailable > 1 ? 's' : ''} left` : 'Sold out' : null;
...
//# sourceMappingURL=_e7edc7ae._.js.map