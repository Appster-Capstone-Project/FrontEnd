...
function SellerOrdersPage() {
    ...
    const fetchOrders = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SellerOrdersPage.useCallback[fetchOrders]": async (token, sellerId)=>{
            setIsLoading(true);
            try {
                ...
                if (response.ok) {
                    ...
                    const sellerOrders = allOrders.filter({
                        "SellerOrdersPage.useCallback[fetchOrders].sellerOrders": (order)=>order.sellerId === sellerId
                    }["SellerOrdersPage.useCallback[fetchOrders].sellerOrders"]);
    ...
    }["SellerOrdersPage.useCallback[fetchOrders]"], [
        toast
    ]);
...
_s(SellerOrdersPage, "TZ+J3PSaU3Q9eEFBU3lekwzT8no=", false, function() {
    return [
