...
const OrderNotificationManager = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrderNotificationManager.useEffect": ()=>{
            ...
            eventSource.addEventListener('OrderPlaced', {
                "OrderNotificationManager.useEffect": (event)=>{
                    try {
            ...
            eventSource.addEventListener('OrderAccepted', {
                "OrderNotificationManager.useEffect": (event)=>{
                    try {
            ...
            eventSource.onerror = ({
                "OrderNotificationManager.useEffect": (error)=>{
...
_s(OrderNotificationManager, "DVNjYKpuimiRi+hKBnO5tg6SD7k=", false, function() {
    return [
