  ...
  return (
    <div className="container py-12 flex flex-col items-center justify-center text-center min-h-[calc(100vh-200px)]">
      ...
      <p className="text-muted-foreground mb-6 max-w-md">
        We couldn't load the vendor details. This might be a temporary issue with the backend service or an invalid vendor ID.
      </p>
      {error?.message && <p className="text-sm text-destructive bg-destructive/10 p-2 rounded-md mb-4">Error: {error.message}</p>}
